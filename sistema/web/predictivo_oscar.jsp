<%-- 
    Document   : predictivo_oscar
    Created on : 29/01/2021, 08:13:19 PM
    Author     : zuagu
--%>
...
<html>
    ...
    <body class=" white" style="font-size: 12px">
                ...
                <div class="col s12 m12 l12 contenido-datos">
                    ...
                    <div class=" col s12 m12 l12">
                        <div id="info_gestor" class=" col s12 m12 l12 div_input_gestor_info  z-depth-1  grey lighten-1">
                            ...
                            <div class="input-field col s3 m3 l3">
                                <input id="CANAL2" type="text" class="validate white" placeholder="" readonly="readonly" value="">
                                <label for="CANAL2">SUBPRODUCTO</label>
                            </div>
                            <div class="input-field col s3 m3 l3">
        ...
        <script type="text/javascript" src="js/js/predictivo_azteca_1.js"></script>
    </body>
</html>